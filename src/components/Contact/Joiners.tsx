const Joiners = () => {
  ...
  return (
    <section className="pt-24 px-8 md:px-16 lg:px-32 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
        {items.map((item, index) => (
          <div
            key={index}
            className="flex items-center justify-center text-center bg-amber-500 shadow-lg rounded-lg p-6 md:py-7"
          >
