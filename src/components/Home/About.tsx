    ...
    <div className="w-full max-w-[1200px] mx-auto h-auto mt-20 px-5 sm:px-10 flex flex-col-reverse lg:flex-row justify-between items-center gap-y-10 lg:gap-y-0 lg:gap-x-20">
      ...
      <div className="text-black">
        ...
        <p className="text-[15px] sm:text-[17px] leading-relaxed text-justify lg:text-left">
          ...
          பாரதியின் பிறந்தநாளாகிய டிசம்பர் 11ஆம் தேதி பேரவை சார்பில் பாரதி விழா
          நடத்தப்பட்டு வருகிறது. இதுவரை 26 ஆண்டுகள் - ஆண்டு தவறாமல், தேதி
          ...
          அணிவகுப்பு நடத்துவது மாநில அளவிலான ஒரு முக்கிய ஆளுமைக்கு பாரதி விருது
          வழங்குவது, ஒரு தனித்துவம் மிக்க சான்றோர் ஒருவரின் திருவுருவப் படத்தைத்
          திறப்பது, இலக்கியச் சொற்பொழிவுகள் இடம்பெறுவது ஆகிய நான்கு முக்கிய
