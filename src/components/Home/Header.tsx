    ...
    <>
      ...
      >
        ...
        <div
          ...
          } text-[38px] sm:text-[60px] md:text-[65px] lg:text-[100px] xl:text-[130px]`}
        >
          பாரதி
        </div>
        ...
        >
          விழா
          <span className="absolute text-[12px] sm:text-[18px] md:text-[20px] lg:text-[28px] xl:text-[40px] text-white top-[44px] sm:top-[60px] md:top-[80px] lg:top-[110px] xl:top-[140px] right-0">
            2024
          </span>
        </div>
      </div>
